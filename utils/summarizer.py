...
### OBJECTIVE:
Convert the transcript into a **comprehensive, detailed hierarchical JSON mind map** that extracts MAXIMUM educational value from every concept discussed. Create an extensive learning resource that thoroughly covers all topics, regardless of video length. Your goal is to produce a rich, detailed mind map that could serve as a complete study guide.

### COMPREHENSIVE EXTRACTION PRINCIPLES:
- **Extract Everything**: Every technique, method, concept, tip, or insight mentioned should be captured and expanded
- **Educational Completeness**: Provide enough detail for thorough understanding and practical application  
- **Depth Over Surface**: Better to have fewer main topics with extensive detail than many shallow topics
- **Expand Brief Mentions**: If something is mentioned briefly, create a full educational breakdown
- **Learning-Focused**: Each node should teach something valuable and actionable

### DETAILED EXTRACTION REQUIREMENTS:

**CONTENT VOLUME TARGETS:**
- **Short videos (<5 min)**: Minimum 15-25 clickable nodes total
- **Medium videos (5-15 min)**: Minimum 25-40 clickable nodes total  
- **Long videos (>15 min)**: Minimum 40+ clickable nodes total

**HIERARCHICAL DEPTH REQUIREMENTS:**
- Extract **3 to 8 main topics** (expand coverage based on content richness)
- Each main topic should have **3 to 8 subtopics** (comprehensive coverage)
- Each subtopic should have **2 to 6 child nodes** when possible (granular details)
- Focus on creating educational value at every level

**CONTENT EXPANSION GUIDELINES:**
- If a technique is mentioned, break down HOW it works step-by-step
- If an example is given, explain WHY it's significant and HOW to apply it
- If a concept is introduced, provide comprehensive explanation and context
- If best practices are shared, capture them as detailed key points
- If tools or methods are discussed, explain their practical application

### INSTRUCTIONS FOR OUTPUT:
- Respond ONLY with **valid JSON** (no explanations, no extra text).
- **Maximize content extraction** - don't leave any educational value unexplored
- For every subtopic, create detailed child_nodes when content supports it
- Each element should contain rich, educational content:
    - `details`: Comprehensive explanations, methodologies, step-by-step processes
    - `examples`: Specific instances, use cases, real-world applications, case studies  
    - `key_points`: Critical insights, best practices, warnings, important facts, actionable tips
- Do NOT create generic categories unless explicitly present in the video
- Maintain **natural flow** (order of discussion as in transcript)
- Create comprehensive explanations that could stand alone as learning material
---
...
- **Maximum Extraction**: Extract and expand EVERY meaningful concept, technique, or insight mentioned
- **Educational Depth**: Each node should provide enough information for practical understanding and application
- **Comprehensive Coverage**: Don't skip topics because they seem "simple" - expand them educationally
- **Learning Value**: Every clickable node should teach something valuable and actionable
...
- Write details and key points as **comprehensive but concise explanations**
- Avoid redundancy between details and key_points across levels
- Be precise, factual, and educational based on transcript content

**ENHANCED CHILD NODES GUIDELINES:**
- **Create child_nodes liberally** - if a subtopic has ANY distinct aspects, methods, or components, break them down
- Child nodes should represent: specific techniques, implementation steps, detailed breakdowns, variations, or specialized aspects
- **Don't default to empty arrays** - actively look for ways to create educational child nodes
- Target 2-6 child nodes per subtopic when content supports it (most subtopics should have children)
- Each child node must have meaningful details, examples, AND/OR key_points
- **Expand brief mentions**: If speaker mentions something briefly, create a full child node explanation

**CONTENT EXPANSION STRATEGIES:**
- **Technique Mentions** → Create full methodology breakdowns with steps and applications
- **Tool References** → Explain what they do, how to use them, and why they're important  
- **Best Practices** → Document as key_points with reasoning and context
- **Examples Given** → Capture and explain their significance and broader applications
- **Concepts Introduced** → Provide comprehensive explanations and practical context
- **Tips/Insights** → Expand into full educational explanations with actionable advice

**CONTENT QUALITY STANDARDS:**
- Each `details` array should have 2-6 comprehensive explanations that teach HOW something works
- Each `examples` array should include specific instances that show practical application
- Each `key_points` array should have 2-5 critical insights, best practices, or important facts
- **No superficial content** - every piece of information should add educational value
---
