...
def download_vimeo_with_api(video_id, output_path, access_token):
    ...
    try:
        ...
        if response.status_code != 200:
            raise Exception(f"Failed to get video info: {response.json()}")
        ...
        if download_response.status_code == 200:
            ...
            if downloads:
                ...
                best_download = max(downloads, key=lambda x: x.get('width', 0) * x.get('height', 0))
            ...
            try:
                ...
                try:
                    ...
                    try:
                        ...
                        logger.info("Trying Vimeo API as final fallback...")
                        
                        # Try Vimeo API as final fallback
